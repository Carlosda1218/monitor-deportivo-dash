# sensors.py
"""
Catálogo de sensores para CombatIQ y helpers de UI.
...
# - metrics: qué métricas clave aporta CombatIQ con ese sensor
SENSOR_CATALOG: Dict[str, Dict] = {
    "ECG": {
        ...
        "description": (
            ...
            "y los intervalos R–R. A partir de estos datos CombatIQ calcula frecuencia cardiaca, "
